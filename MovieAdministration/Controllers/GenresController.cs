...
namespace MovieAdministration.Controllers
{
    ...
    public class GenresController : ControllerBase
    {
        ...
        {
            return await _context.Genres_1.ToListAsync();
        }
        ...
        {
            var genres = await _context.Genres_1.FindAsync(id);
        ...
        public async Task<IActionResult> DeleteGenres(int id)
        {
            ...
            _context.Genres_1.Remove(genres);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.Genres_1.Any(e => e.Id == id);
        }
    }
}
